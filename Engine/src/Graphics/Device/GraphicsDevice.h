...
namespace Engine
{
    ...
    public:
        ...
        */
        ...
        // TODO : 
        /// @return Returns ShaderProgram array's address.
    ...
    protected:
         ...
         * @return if returns false Window will be aborted without hesitation.
        */
        bool CreateDeviceContext(const DriverTypes driverValue = DriverTypes::Hardware, const FeatureTypes featureValue = FeatureTypes::Dx11);
        /**
